        ...
        $res .= '<tr>
            ...
            <td>
                <a href="#" class="btn btn-success"
                    onclick="editar( ' . $plataformas->fields[0] . ', \'' . $plataformas->fields[1] . '\', \'' . $plataformas->fields[2] . '\', \'' . $plataformas->fields[3] . '\', \'' . $plataformas->fields[4] . '\', \'' . $plataformas->fields[5] . '\', \'' . $plataformas->fields[6] . '\')">Editar</a>
            </td>
            <td>
            <a href="../controllers/carritoController.php?opc=3&id=' . $plataformas->fields[0] . '" class="btn btn-danger">Eliminar</a>
